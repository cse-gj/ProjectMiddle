package com.sample.projectmiddle;
...
import com.sample.projectmiddle.model.UserModel;
...
public class SignupActivity extends AppCompatActivity {
    ...
    private Uri imageUri; //업르드 할 떄 담아준다.
                ...
                FirebaseAuth.getInstance()
                        ...
                        .addOnCompleteListener(SignupActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) { //회원가입 완료시
                                ...
                                String uid = task.getResult().getUser().getUid(); //이름 넣는 곳
